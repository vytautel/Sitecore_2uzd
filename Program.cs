...
namespace Akademija_Sitecore_Lipeikaite_Vytaute_2_uzd
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            SkaitymaiIsFailu(DuomFailVardai, kiek_f, Tekstai);
        ...
        static void SkaitymaiIsFailu(string[] DuomFailVardai, int kiek, string[] Tekstai)
        {
            for ( int i = 0; i < kiek; i++ )
            {
                SkaitymasIsFailo(DuomFailVardai[i], out Tekstai[i]);
            }
        }

        static void SkaitymasIsFailo(string failo_vardas, out string tekstas)
        {
            tekstas = "";
